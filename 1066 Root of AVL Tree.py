...
2. 平衡：因为简单插入会导致搜索二叉树不等臂，造成搜索效能下降，故如果出现不等臂（即题目中，某节点的左右子树高度相差大于1），就需要平衡（因为我们是一个个节点插入，所以左右子树高度最大差值为2）
    ...
    2. 如果右子树高，则为左旋
        ...
        3. 将原根节点设为右叶节点的左叶节点
    3. 当在左边插入时，即插入值小于“比较根节点”，但若插入值大于“比较根节点”的左叶节点，则表明插入的值应为“比较根节点”的左叶节点，而非孙节点，故可以“比较根节点”的左叶节点为根进行右旋，然后再进行1步骤
    4. 当在右边插入时，即插入值大等于于“比较根节点”，但若插入值小于等于“比较根节点”的右叶节点，则表明插入的值应为“比较根节点”的右叶节点，而非孙节点，故可以“比较根节点”的右叶节点为根进行左旋，然后再进行2步骤
"""
######################################
